...
namespace ssa
{
	...
	public:
		...
		void SensValCallBack(const std::string& strDataSetName, char* pBuffer, long long  lAbsTime);
		void SensValCallBack(const std::string& strDataSetName, long long  lAbsTime);
		//当数据信息有变化时，回调
